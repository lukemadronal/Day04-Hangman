...
## Day 04 Homework - Part 3
### Hangman

MINIMUM requirements for this assignment:
* Create a Hangman game
* You the supplied word list & images
* Pick a random word from the list
* The player must have at least 10 chances to answer each word
* The game must notify the user if they’ve won or lost

OPTIONAL hard mode for this assignment:
* Use size classes in auto layout to rearrange the game to make it look good in all devices & orientations

OPTIONAL expert mode for this assignment:
* Add phrases to the word list (i.e. multiple words separated by spaces) and handle the spaces in the game